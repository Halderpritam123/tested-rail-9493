    ...
    return (<Box>
        ...
        <Center>
            <Box display="grid" gridTemplateColumns='repeat(4, 1fr)' gap={5}>
                <Box border={"1px solid gray"} boxShadow='base' borderRadius="7px"><Img src="https://images-static.nykaa.com/uploads/9b5d2e95-9862-4210-9052-69d57e266c1a.png?tr=w-300,cm-pad_resize" /></Box>
