...
export default function NavBar() {
  ...
  return (
    <Box>
      <Box pos="fixed" textAlign="center" fontFamily="sans-serif" w="100%" zIndex={99999}>
        ...
        <Flex
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
           ...
           <Text
              ...
              <Img onClick={ <Navigate to="/"/>} w={100} src={logo} align="center" p={1} />
            </Text>
        ...
        <Box borderBottom={1}
          borderStyle={'solid'}
          borderColor={useColorModeValue('gray.200', 'gray.900')} py={2} display="flex" justifyContent="space-around" px={50} align={Center} bg="white" boxShadow="rgba(0, 0, 0, 0.24) 0px 3px 8px">
          <Link href='/makeup'><Tooltip maxWidth="500%" bg="white" color="black" label={<Navoptions />}  >
            Makeup
          </Tooltip></Link>
...
const NAV_ITEMS: Array<NavItem> = [
    ...
    href:'/'},
  {
    ...
    children: [
      {
        label: <Link to="makeup">Makeup</Link>,
        // subLabel: 'Face',
        href: '/makeup',
      },
      {
